<template>
  <div class="container mx-auto">
    <h1>Privacy Policy for codingwithjohan.com</h1>

    <p>
      At Coding with Johan, accessible from https://codingwithjohan.com/, one of
      ...
      Coding with Johan and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in Coding with Johan. This policy is not applicable to any
    ...
    <p>
      Coding with Johan follows a standard procedure of using log files. These
    ...
    <p>
      Like any other website, Coding with Johan uses 'cookies'. These cookies
    ...
    <p>
      ...
      advertising partners of Coding with Johan.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Coding with Johan, which are sent
    ...
    <p>
      Note that Coding with Johan has no access to or control over these cookies
    ...
    <p>
      Coding with Johan's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      Coding with Johan does not knowingly collect any Personal Identifiable
